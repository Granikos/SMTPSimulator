...
namespace Granikos.Hydra.Service.PriorityQueue
{
    ...
    public sealed class HeapPriorityQueue<K, T> : IPriorityQueue<K, T>
        ...
        where K : IComparable<K>
    {
        ...
        private bool HasHigherPriority(T higher, T lower)
        {
            ...
            return (compare < 0 ||
                    (compare == 0 && higher.InsertionIndex < lower.InsertionIndex));
        }
